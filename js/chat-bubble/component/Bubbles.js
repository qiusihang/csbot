...
function Bubbles(container, self, options) {
    ...
    this.typeInput = function(callbackFn) {
        ...
        inputText.setAttribute("placeholder", "Click bubbles to choose your reply, or press <Enter> to send your message...");
        ...
        //inputText.focus();   // when the chatbot is embedded in other page, comment this line
    };
    ...
    this.answer = function(key, content) {
        ...
        typeof options.inputCallbackFn === "function" ?
            options.inputCallbackFn({
                input: this.value,
                convo: _convo,
                standingAnswer: standingAnswer,
                answer: key
        ...
        if (reply !== "") {
            ...
            bubble.addEventListener("click", function() {
                for (var i = 0; i < bubbleButtons.length; i++) {
                    ...
                    (function(el) {
                        el.style.width = 0 + "px";
                        el.classList.contains("bubble-pick") ? (el.style.width = "") : el.style.display="none";
